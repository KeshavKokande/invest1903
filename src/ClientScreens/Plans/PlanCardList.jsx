...
const PlanCardList = ({ plans }) => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <div className="cl_container" style={{backgroundColor: "rgb(71, 91, 232)"}}>
        <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' ,flex:'50%'}}>
          <div style={{ marginRight: '0', flex:40}}>
            Search:
            <input
              type="text"
              name="searchText"
          ...
          <div style={{ marginRight: '0.1rem' }}>
            <div style={{ position: 'relative' }}>
              <button onClick={() => setShowFilterDropdown(!showFilterDropdown)}> <FontAwesomeIcon icon={faFilter} size="2x" /></button>
              {showFilterDropdown && (
